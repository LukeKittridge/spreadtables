...
// return the number of states currently on the stack
            ...
            performAction: function anonymous(yy,yy_,$avoiding_name_collisions,YY_START) {
                ...
                switch($avoiding_name_collisions) {
                    ...
                    case 8:return 12;
                        break;
                    case 9:return 'TableName';
                        break;
                    case 10:return 'LocalCellName';
                        break;
                    case 11:return 'LocalCell';
                        break;
                    case 12:return 'GlobalCellName';
                        break;
                    case 13:return 'GlobalCell';
                        break;
                    case 14:return 5;
                        break;
                }
            },
            rules: [/^(?:\s+)/,/^(?:[0-9]+(?:\.[0-9]+)?\b)/,/^(?:\*)/,/^(?:\/)/,/^(?:-)/,/^(?:\+)/,/^(?:\^)/,/^(?:\()/,/^(?:\))/,/^(?:^#\w+$)/,/^(?:^[a-zA-Z](?:[a-zA-Z][a-zA-Z]\w*)?$)/,/^(?:^[a-zA-Z]{1,2}[1-9]\d?$)/,/^(?:^\w+.[a-zA-Z](?:[a-zA-Z][a-zA-Z]\w*)?$)/,/^(?:^\w+.[a-zA-Z]{1,2}[1-9]\d?$)/,/^(?:$)/],
